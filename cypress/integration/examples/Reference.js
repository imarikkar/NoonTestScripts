describe('Noon Tests', function() {
  // Define what the test does.
    it('Visit Noon, selection of the first electronics item, add to cart and proceed to check out by utilizing a dummy address', function() {
      // Visit Noon website
      ...
      // Verify landed back to home page
      cy.url().should('eq', 'https://www.noon.com/uae-en/')
      // Navigate to Electornics section
      ...
      // Allow 4 seconds for the dynamic search box load information
      cy.wait (4000)
      // Select the suggested address from the dynamic search box
      cy.get ('.active > .jsx-2777892782').click() 
      // Allow 4 seconds for the suggested address to be selected
      cy.wait (4000)
      ...
      // Click on Continue
      cy.get ('.ripple > .jsx-3898435964').click() 
      // I had to stop the workflow here since an OTP sent to the mobile phone is required to proceed. 
    })
  })